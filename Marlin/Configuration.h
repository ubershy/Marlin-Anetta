...
#define STRING_CONFIG_H_AUTHOR "((Litty, Anetta))" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Anetta ^_^"
...
//
// Litty: actual max temp is 285C, but marlin doesn't allow working with temperatures higher than [HEATER_0_MAXTEMP-15]
// and will error upon reaching HEATER_0_MAXTEMP.
// That's why using 305C, like in prusa mk3
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 35.42
  #define DEFAULT_bedKd 668.39
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 93.8433 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 120, 120, 10, 40 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -29, 27, -1.48 }
...
#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_START_POINT   { { 142.11, -12.1, (Z_MIN_POS + 1) } }
  #define NOZZLE_CLEAN_END_POINT { {  77.89, -3.5, (Z_MIN_POS + 1) } }
